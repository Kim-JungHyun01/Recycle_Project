    ...
    public CommandLineRunner initializeData() {
        return args -> {
            if (itemRepository.count() == 0) {
                ...
                itemRepository.save(new Item("Monitor", "TV + 모니터", 7000));
